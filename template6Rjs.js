 ...
 async function uploadprocess()
{
  ...
  ()=>{
    uploadTask.snapshot.ref.getDownloadURL().then((downloadUrl)=>{
      ...
      database.ref('users/'+user.uid+'/template6'+'/Personal-data').child('ImagesLinks').set(downloadUrl)
      userurl=downloadUrl
      console.log(userurl);
    })
  })
...
function geturlfromdatabase(URL)
{
  const realdb = firebase.database();
   ...
   const imageUrlRef = firebase.database().ref(`users/${userId}/template6/Personal-data/ImagesLinks`);
...
firebase.auth().onAuthStateChanged((user)=>{
    if(!user){
        ...
        var nameInput = document.getElementById('First-Name-input')
        let FirstnameT=document.getElementById("FirstnameT");
        database.ref('users/' + user.uid +'/template6'+'/Personal-data').once('value')
        .then((snapshot) => {
         ...
         database.ref('users/' + user.uid +'/template6'+'/Personal-data'+'/Introduction').once('value')
         .then((snapshot) => {
      ...
      database.ref('users/' + user.uid +'/template6'+'/Personal-data'+'/lastname').once('value')
      .then((snapshot) => {
       ...
       database.ref('users/' + user.uid +'/template6'+'/Personal-data'+'/profession').once('value')
.then((snapshot) => {
 ...
 database.ref('users/' + user.uid +'/template6'+'/Personal-data'+'/city').once('value')
 .then((snapshot) => {
    const city = snapshot.val();
 
    CityInput.value=city
  })
  database.ref('users/' + user.uid +'/template6'+'/Personal-data'+'/country').once('value')
  .then((snapshot) => {
     const city = snapshot.val();
  
     CountryInput.value=city
   })
   database.ref('users/' + user.uid +'/template6'+'/Personal-data'+'/pincode').once('value')
   .then((snapshot) => {
      const city = snapshot.val();
   
      PinCode2Input.value=city
    })
    database.ref('users/'+user.uid+'/template6'+'/Personal-data'+'/phone').once('value')
    .then((snapshot) => {
      const phone = snapshot.val();
   
      PhoneIN.value=phone
    })
    database.ref('users/'+user.uid+'/template6'+'/Personal-data'+'/emailT').once('value')
    .then((snapshot) => {
    ...
    database.ref('users/'+user.uid+'/template6'+'/Work-Experience'+'/Job-Title').once('value')
    .then((snapshot) => {
      const Jobtitleinputs = snapshot.val();
   
      Jobtitleinput.value=Jobtitleinputs;
    })
    database.ref('users/'+user.uid+'/template6'+'/Work-Experience'+'/Employer-Position').once('value')
    .then((snapshot) => {
    ...
    database.ref('users/'+user.uid+'/template6'+'/Work-Experience'+'/City-Work').once('value')
    .then((snapshot) => {
    ...
    database.ref('users/'+user.uid+'/template6'+'/Work-Experience'+'/Country').once('value')
    .then((snapshot) => {
    ...
    database.ref('users/'+user.uid+'/template6'+'/Work-Experience'+'/Start-Date').once('value')
    .then((snapshot) => {
    ...
    database.ref('users/'+user.uid+'/template6'+'/Work-Experience'+'/End-Date').once('value')
    .then((snapshot) => {
    ...
    database.ref('users/'+user.uid+'/template6'+'/Work-Experience'+'/Work-Experience-Info').once('value')
    .then((snapshot) => {
    ...
    //workex-2
    database.ref('users/'+user.uid+'/template6'+'/Work-Experience2'+'/Job-Title').once('value')
    .then((snapshot) => {
      const Jobtitleinputs = snapshot.val();
      var Jobtitleinputw2=document.getElementById("Jobtitle-input-w2").value=Jobtitleinputs;
   
    })
    database.ref('users/'+user.uid+'/template6'+'/Work-Experience2'+'/Employer-Position').once('value')
    .then((snapshot) => {
      const Employerinputs = snapshot.val();
    ...
    database.ref('users/'+user.uid+'/template6'+'/Work-Experience2'+'/City-Work').once('value')
    .then((snapshot) => {
      const CityinputWorkexperiences = snapshot.val();
    ...
    database.ref('users/'+user.uid+'/template6'+'/Work-Experience2'+'/Country').once('value')
    .then((snapshot) => {
      const CountryinputWorkexperiences = snapshot.val();
    ...
    database.ref('users/'+user.uid+'/template6'+'/Work-Experience2'+'/Start-Date').once('value')
    .then((snapshot) => {
      const  StartDateWorkExinputs = snapshot.val();
    ...
    database.ref('users/'+user.uid+'/template6'+'/Work-Experience2'+'/End-Date').once('value')
    .then((snapshot) => {
      const  EndDateWorkExinputs = snapshot.val();
    ...
    database.ref('users/'+user.uid+'/template6'+'/Work-Experience2'+'/Work-Experience-Info').once('value')
    .then((snapshot) => {
      const WorkExtextareas = snapshot.val();
    ...
    //work3
    database.ref('users/'+user.uid+'/template6'+'/Work-Experience3'+'/Job-Title').once('value')
    .then((snapshot) => {
      const Jobtitleinputs = snapshot.val();
      var Jobtitleinputw2=document.getElementById("Jobtitle-input-w3").value=Jobtitleinputs;
  
    })
    database.ref('users/'+user.uid+'/template6'+'/Work-Experience3'+'/Employer-Position').once('value')
    .then((snapshot) => {
      const Employerinputs = snapshot.val();
    ...
    database.ref('users/'+user.uid+'/template6'+'/Work-Experience3'+'/City-Work').once('value')
    .then((snapshot) => {
      const CityinputWorkexperiences = snapshot.val();
    ...
    database.ref('users/'+user.uid+'/template6'+'/Work-Experience3'+'/Country').once('value')
    .then((snapshot) => {
      const CountryinputWorkexperiences = snapshot.val();
      let CountryinputWorkexperience=document.getElementById("Country-input-Workexperience-w3").value=CountryinputWorkexperiences;

    })
    database.ref('users/'+user.uid+'/template6'+'/Work-Experience3'+'/Start-Date').once('value')
    .then((snapshot) => {
      const  StartDateWorkExinputs = snapshot.val();
    ...
    database.ref('users/'+user.uid+'/template6'+'/Work-Experience3'+'/End-Date').once('value')
    .then((snapshot) => {
      const  EndDateWorkExinputs = snapshot.val();
    ...
    database.ref('users/'+user.uid+'/template6'+'/Work-Experience3'+'/Work-Experience-Info').once('value')
    .then((snapshot) => {
      const WorkExtextareas = snapshot.val();
    ...
    database.ref('users/'+user.uid+'/template6'+'/Education'+'/School-Name').once('value')
    .then((snapshot) => {
    ...
    database.ref('users/'+user.uid+'/template6'+'/Education'+'/School-Location').once('value')
    .then((snapshot) => {
    ...
    database.ref('users/'+user.uid+'/template6'+'/Education'+'/Degree').once('value')
    .then((snapshot) => {
    ...
    database.ref('users/'+user.uid+'/template6'+'/Education'+'/Field-of-Study').once('value')
    .then((snapshot) => {
    ...
    database.ref('users/'+user.uid+'/template6'+'/Education'+'/Graduation-Start-Date').once('value')
    .then((snapshot) => {
    ...
    database.ref('users/'+user.uid+'/template6'+'/Education'+'/Graduation-End-Date').once('value')
    .then((snapshot) => {
    ...
    database.ref('users/'+user.uid+'/template6'+'/Education'+'/Education-Info').once('value')
    .then((snapshot) => {
    ...
    database.ref('users/'+user.uid+'/template6'+'/Education2'+'/School-Name').once('value')
    .then((snapshot) => {
      const   SchoolNameinputs= snapshot.val();
    ...
    database.ref('users/'+user.uid+'/template6'+'/Education2'+'/School-Location').once('value')
    .then((snapshot) => {
      const   SchoolLocationinputs= snapshot.val();
    ...
    database.ref('users/'+user.uid+'/template6'+'/Education2'+'/Degree').once('value')
    .then((snapshot) => {
      const  Degreeinputs= snapshot.val();
    ...
    database.ref('users/'+user.uid+'/template6'+'/Education2'+'/Field-of-Study').once('value')
    .then((snapshot) => {
      const  FieldofStudys= snapshot.val();
    ...
    database.ref('users/'+user.uid+'/template6'+'/Education2'+'/Graduation-Start-Date').once('value')
    .then((snapshot) => {
      const  GraduationStartDates= snapshot.val();
    ...
    database.ref('users/'+user.uid+'/template6'+'/Education2'+'/Graduation-End-Date').once('value')
    .then((snapshot) => {
      const  GraduationEndDates= snapshot.val();
    ...
    database.ref('users/'+user.uid+'/template6'+'/Education2'+'/Education-Info').once('value')
    .then((snapshot) => {
      const  EducationInfo= snapshot.val();
    ...
    database.ref('users/'+user.uid+'/template6'+'/Education3'+'/School-Name').once('value')
    .then((snapshot) => {
      const   SchoolNameinputs= snapshot.val();
    ...
    database.ref('users/'+user.uid+'/template6'+'/Education3'+'/School-Location').once('value')
    .then((snapshot) => {
      const   SchoolLocationinputs= snapshot.val();
    ...
    database.ref('users/'+user.uid+'/template6'+'/Education3'+'/Degree').once('value')
    .then((snapshot) => {
      const  Degreeinputs= snapshot.val();
    ...
    database.ref('users/'+user.uid+'/template6'+'/Education3'+'/Field-of-Study').once('value')
    .then((snapshot) => {
      const  FieldofStudys= snapshot.val();
    ...
    database.ref('users/'+user.uid+'/template6'+'/Education3'+'/Graduation-Start-Date').once('value')
    .then((snapshot) => {
      const  GraduationStartDates= snapshot.val();
    ...
    database.ref('users/'+user.uid+'/template6'+'/Education3'+'/Graduation-End-Date').once('value')
    .then((snapshot) => {
      const  GraduationEndDates= snapshot.val();
    ...
    database.ref('users/'+user.uid+'/template6'+'/Education3'+'/Education-Info').once('value')
    .then((snapshot) => {
      const  EducationInfo= snapshot.val();
    ...
    database.ref('users/' + user.uid +'/template6'+'/Work-Experience'+'/WorkExperienceCount').once('value')
    .then((snapshot) => {
       const WorkExperienceCount= snapshot.val();
       if(WorkExperienceCount<=0)
       {
         database.ref('users/'+user.uid+'/template6'+'/Work-Experience').child('WorkExperienceCount').set(clickCount=0);
...
else if(WorkExperienceCount>=3)
{
  alert("Worexperence-add Limit is over")
   ...
   database.ref('users/' + user.uid +'/template6'+'/Education'+'/EducationCount').once('value')
   .then((snapshot) => {
      const WorkExperienceCount= snapshot.val();
 if(WorkExperienceCount<0)
 {
   database.ref('users/'+user.uid+'/template6'+'/Education').child('EducationCount').set(clickCounteducation=0);
 ...
 {
   alert("Worexperence-add Limit is over")
   database.ref('users/'+user.uid+'/template6'+'/Education').child('EducationCount').set(clickCounteducation=2);
 }
...
{ 
  ...
  document.getElementById("education-ex-id-3T").style.display="block";
   ...
   database.ref('users/' + user.uid +'/template6'+'/Add-Section').once('value')
   .then((snapshot) => {
   ...
   database.ref('users/' + user.uid +'/template6'+'/personal-section'+'/personal-section-heading').once('value')
   .then((snapshot) => {
   ...
   database.ref('users/' + user.uid +'/template6'+'/Certification').once('value')
   .then((snapshot) => {
...
database.ref('users/' + user.uid +'/template6'+'/Interest').once('value')
.then((snapshot) => {
  ...
  database.ref('users/' + user.uid +'/template6'+'/Software').once('value')
  .then((snapshot) => {
    ...
    database.ref('users/' + user.uid +'/template6'+'/personal-section'+'/personal-section-info').once('value')
    .then((snapshot) => {
      ...
      database.ref('users/' + user.uid +'/template6'+'/Language').once('value')
      .then((snapshot) => {
        ...
        var Language4=document.getElementById("Language4");
         ...
         var Skill3T=document.getElementById("Language3T").innerHTML=Interests3info;
          ...
          database.ref('users/' + user.uid +'/template6'+'/skill').once('value')
          .then((snapshot) => {
           ...
           database.ref('users/' + user.uid +'/template6'+'/Affiliations'+'/Affiliations-info').once('value')
           .then((snapshot) => {
            ...
            database.ref('users/' + user.uid +'/template6'+'/Additional-Information'+'/Additional-Information-info').once('value')
            .then((snapshot) => {
  ...
  database.ref('users/' + user.uid +'/template6'+'/Accompliments'+'/Accomplishments-info').once('value')
.then((snapshot) => {
   const Accomplishmentsinfo = snapshot.val();
   var Accomplishmentstextarea=document.getElementById("Accomplishments-textarea");
...
function academicdata()
{
  const database = firebase.database();
  var user = firebase.auth().currentUser;
  database.ref('users/'+user.uid+'/template6'+'/Education').child('School-Name').set(SchoolNameinput.value)
  database.ref('users/'+user.uid+'/template6'+'/Education').child('School-Location').set(SchoolLocationinput.value)
  database.ref('users/'+user.uid+'/template6'+'/Education').child('Degree').set(Degreeinput.value)
  database.ref('users/'+user.uid+'/template6'+'/Education').child('Field-of-Study').set(FieldofStudy.value)
  database.ref('users/'+user.uid+'/template6'+'/Education').child('Graduation-Start-Date').set(GraduationStartDate.value)
  database.ref('users/'+user.uid+'/template6'+'/Education').child('Graduation-End-Date').set(GraduationEndDate.value)

  database.ref('users/'+user.uid+'/template6'+'/Education').child('Education-Info').set(Educationtextarea.value)
  academicinputandinnerhtml()
}
...
// let DegreeT=document.getElementById("DegreeT");
// let SchoolNameAddrres=document.getElementById("School-Name-Addrres");
  database.ref('users/'+user.uid+'/template6'+'/Education2').child('School-Name').set(SchoolNameinput.value)
  database.ref('users/'+user.uid+'/template6'+'/Education2').child('School-Location').set(SchoolLocationinput.value)
  database.ref('users/'+user.uid+'/template6'+'/Education2').child('Degree').set(Degreeinput.value)
  database.ref('users/'+user.uid+'/template6'+'/Education2').child('Field-of-Study').set(FieldofStudy.value)
  database.ref('users/'+user.uid+'/template6'+'/Education2').child('Graduation-Start-Date').set(GraduationStartDate.value)
  database.ref('users/'+user.uid+'/template6'+'/Education2').child('Graduation-End-Date').set(GraduationEndDate.value)

  database.ref('users/'+user.uid+'/template6'+'/Education2').child('Education-Info').set(Educationtextarea.value)
  academicinputandinnerhtml2();
}
...
// let DegreeT=document.getElementById("DegreeT");
// let SchoolNameAddrres=document.getElementById("School-Name-Addrres");
  database.ref('users/'+user.uid+'/template6'+'/Education3').child('School-Name').set(SchoolNameinput.value)
  database.ref('users/'+user.uid+'/template6'+'/Education3').child('School-Location').set(SchoolLocationinput.value)
  database.ref('users/'+user.uid+'/template6'+'/Education3').child('Degree').set(Degreeinput.value)
  database.ref('users/'+user.uid+'/template6'+'/Education3').child('Field-of-Study').set(FieldofStudy.value)
  database.ref('users/'+user.uid+'/template6'+'/Education3').child('Graduation-Start-Date').set(GraduationStartDate.value)
  database.ref('users/'+user.uid+'/template6'+'/Education3').child('Graduation-End-Date').set(GraduationEndDate.value)

  database.ref('users/'+user.uid+'/template6'+'/Education3').child('Education-Info').set(Educationtextarea.value)
  academicinputandinnerhtml3();
}
function Workexperiencedata()
{
  const database = firebase.database();
  var user = firebase.auth().currentUser;
  database.ref('users/'+user.uid+'/template6'+'/Work-Experience').child('Job-Title').set(Jobtitleinput.value)
  database.ref('users/'+user.uid+'/template6'+'/Work-Experience').child('Employer-Position').set(Employerinput.value)
  database.ref('users/'+user.uid+'/template6'+'/Work-Experience').child('City-Work').set(CityinputWorkexperience.value)
  database.ref('users/'+user.uid+'/template6'+'/Work-Experience').child('Country').set(CountryinputWorkexperience.value)
  database.ref('users/'+user.uid+'/template6'+'/Work-Experience').child('Start-Date').set(StartDateWorkExinput.value)
  database.ref('users/'+user.uid+'/template6'+'/Work-Experience').child('End-Date').set(EndDateWorkExinput.value)

  database.ref('users/'+user.uid+'/template6'+'/Work-Experience').child('Work-Experience-Info').set(WorkExtextarea.value)
  workexperienceinputandinnerhtml();
}
...
let WorkExtextarea=document.getElementById("Work-Ex-textarea-w2");
  ...
  let WorkExdateT=document.getElementById("Work-Ex-date")
  database.ref('users/'+user.uid+'/template6'+'/Work-Experience2').child('Job-Title').set(Jobtitleinputw2.value)
  database.ref('users/'+user.uid+'/template6'+'/Work-Experience2').child('Employer-Position').set(Employerinput.value)
  database.ref('users/'+user.uid+'/template6'+'/Work-Experience2').child('City-Work').set(CityinputWorkexperience.value)
  database.ref('users/'+user.uid+'/template6'+'/Work-Experience2').child('Country').set(CountryinputWorkexperience.value)
  database.ref('users/'+user.uid+'/template6'+'/Work-Experience2').child('Start-Date').set(StartDateWorkExinput.value)
  database.ref('users/'+user.uid+'/template6'+'/Work-Experience2').child('End-Date').set(EndDateWorkExinput.value)

  database.ref('users/'+user.uid+'/template6'+'/Work-Experience2').child('Work-Experience-Info').set(WorkExtextarea.value)
  workexperienceinputandinnerhtml2();
}
...
let WorkExtextarea=document.getElementById("Work-Ex-textarea-w3");
  ...
  let WorkExdateT=document.getElementById("Work-Ex-date")
  database.ref('users/'+user.uid+'/template6'+'/Work-Experience3').child('Job-Title').set(Jobtitleinputw2.value)
  database.ref('users/'+user.uid+'/template6'+'/Work-Experience3').child('Employer-Position').set(Employerinput.value)
  database.ref('users/'+user.uid+'/template6'+'/Work-Experience3').child('City-Work').set(CityinputWorkexperience.value)
  database.ref('users/'+user.uid+'/template6'+'/Work-Experience3').child('Country').set(CountryinputWorkexperience.value)
  database.ref('users/'+user.uid+'/template6'+'/Work-Experience3').child('Start-Date').set(StartDateWorkExinput.value)
  database.ref('users/'+user.uid+'/template6'+'/Work-Experience3').child('End-Date').set(EndDateWorkExinput.value)

  database.ref('users/'+user.uid+'/template6'+'/Work-Experience3').child('Work-Experience-Info').set(WorkExtextarea.value)
  workexperienceinputandinnerhtml3();
}
...
function academicinputandinnerhtml()
{
  const database = firebase.database();
  var user = firebase.auth().currentUser;
  database.ref('users/' + user.uid + '/template6'+'/Education').once('value')
  .then((snapshot) => {
...
let SchoolNameAddrres=document.getElementById("School-Name-Addrres3");
  const database = firebase.database();
  var user = firebase.auth().currentUser;
  database.ref('users/' + user.uid + '/template6'+'/Education3').once('value')
  .then((snapshot) => {
    const SchoolNameinput = snapshot.child('School-Name').val();
...
let SchoolNameAddrres=document.getElementById("School-Name-Addrres2");
  const database = firebase.database();
  var user = firebase.auth().currentUser;
  database.ref('users/' + user.uid + '/template6'+'/Education2').once('value')
  .then((snapshot) => {
    const SchoolNameinput = snapshot.child('School-Name').val();
...
var workexpereincetextareaT=document.getElementById("work-expereince-textareaT-w2")
  database.ref('users/' + user.uid + '/template6'+'/Work-Experience2').once('value')
  .then((snapshot) => {
...
var workexpereincetextareaT=document.getElementById("work-expereince-textareaT-w3")
  database.ref('users/' + user.uid + '/template6'+'/Work-Experience3').once('value')
  .then((snapshot) => {
    const Jobtitleinput = snapshot.child('Job-Title').val();
...
function workexperienceinputandinnerhtml()
{
  ...
  database.ref('users/' + user.uid + '/template6'+'/Work-Experience').once('value')
  .then((snapshot) => {
    const Jobtitleinput = snapshot.child('Job-Title').val();
    JobtitleT.innerHTML=Jobtitleinput;
    const Employerinput=snapshot.child('Employer-Position').val();
...
database.ref('users/'+user.uid+'/template6'+'/Personal-data').child('firstname').set(nameInput.value);
database.ref('users/' + user.uid +'/template6'+'/Personal-data').once('value')
.then((snapshot) => {
   const Firstname = snapshot.child('firstname').val();
   const lastname = snapshot.child('lastname').val();
 ...
 database.ref('users/'+user.uid+'/template6'+'/Personal-data').child('Introduction').set(Introductioninput.value);
database.ref('users/' + user.uid +'/template6'+'/Personal-data'+'/Introduction').once('value')
.then((snapshot) => {
   const Introduction = snapshot.val();
...
database.ref('users/'+user.uid+'/template6'+'/Personal-data').child('lastname').set(lastnameName.value);
database.ref('users/' + user.uid +'/template6'+'/Personal-data'+'/lastname').once('value')
.then((snapshot) => {
   const lastname = snapshot.val();
   lastnameT.innerHTML=lastname;
...
database.ref('users/'+user.uid+'/template6'+'/Personal-data').child('profession').set(ProfessionInput.value);
database.ref('users/' + user.uid +'/template6'+'/Personal-data'+'/profession').once('value')
.then((snapshot) => {
   const Profession = snapshot.val();
   ProfessionT.innerHTML=Profession; 
 ...
 database.ref('users/'+user.uid+'/template6'+'/Personal-data').child('city').set(CityInput.value);
 database.ref('users/'+user.uid+'/template6'+'/Personal-data').child('country').set(CountryInput.value);
 database.ref('users/'+user.uid+'/template6'+'/Personal-data').child('pincode').set(PinCode2Input.value)
 database.ref('users/'+user.uid+'/template6'+'/Personal-data').child('phone').set(PhoneIN.value)
 database.ref('users/'+user.uid+'/template6'+'/Personal-data').child('emailT').set(EmailIN.value)
...
buttonadd.addEventListener('click', function() {
  ...
  database.ref('users/'+user.uid+'/template6'+'/Work-Experience').child('WorkExperienceCount').set(clickCount);
...
{
  alert("Worexperence-add Limit is over")
  database.ref('users/'+user.uid+'/template6'+'/Work-Experience').child('WorkExperienceCount').set(clickCount=2);
}
...
Educationaddbtn.addEventListener('click', function() {
  ...
  database.ref('users/'+user.uid+'/template6'+'/Education').child('EducationCount').set(clickCounteducation)
  database.ref('users/' + user.uid +'/template6'+'/Education'+'/EducationCount').once('value')
  .then((snapshot) => {
     const WorkExperienceCount= snapshot.val();
if(WorkExperienceCount<0)
...
var useraddedsection=document.getElementById("user-added-section");
  ...
  database.ref('users/'+user.uid+'/template6'+'/Add-Section').child('Accomplishments-checkbox').set(Accomplishments.checked);
  database.ref('users/'+user.uid+'/template6'+'/Add-Section').child('perstionalsection-checkbox').set(perstionalsection.checked);
   

  database.ref('users/'+user.uid+'/template6'+'/Add-Section').child('Affiliations-checkbox').set(Affiliations.checked);
   

  
  database.ref('users/'+user.uid+'/template6'+'/Add-Section').child('Additional-Information-checkbox').set(AdditionalInformation.checked);

   

  database.ref('users/'+user.uid+'/template6'+'/Add-Section').child('software-checkbox').set(Software.checked);
  database.ref('users/'+user.uid+'/template6'+'/Add-Section').child('Languages-checkbox').set(Languages.checked);


  database.ref('users/'+user.uid+'/template6'+'/Add-Section').child('Certification-checkbox').set(Certifications.checked);


 
  database.ref('users/'+user.uid+'/template6'+'/Add-Section').child('Interset').set( Interestsinput.checked);


  database.ref('users/'+user.uid+'/template6'+'/personal-section'+'/perstionalsection-checkbox').set( perstionalsection.checked);
...
perstionalsections.checked=true;
  var personalsectionaddinput=document.getElementById("personalsectionaddinput");
  database.ref('users/'+user.uid+'/template6'+'/personal-section'+'/personal-section-heading').set(personalsectionaddinput.value);
var personalsectiondivT=document.getElementById("personal-section-divT").style.display="block";
database.ref('users/' + user.uid +'/template6'+'/personal-section'+'/personal-section-heading').once('value')
.then((snapshot) => {
   const personalsectionaddinput = snapshot.val();
...
function Affiliationsinfo()
{
  ...
  var user = firebase.auth().currentUser;
  var Affiliationstextarea=document.getElementById("Affiliations-textarea");
  database.ref('users/'+user.uid+'/template6'+'/Affiliations').child('Affiliations-info').set(Affiliationstextarea.value);
  database.ref('users/' + user.uid +'/template6'+'/Affiliations'+'/Affiliations-info').once('value')
  .then((snapshot) => {
     const Affiliationsinfo = snapshot.val();
...
{ const database = firebase.database();
  var user = firebase.auth().currentUser;
 var  AdditionalInformationtextarea=document.getElementById("Additional-Information-textarea");
 database.ref('users/'+user.uid+'/template6'+'/Additional-Information').child('Additional-Information-info').set(AdditionalInformationtextarea.value);
 database.ref('users/' + user.uid +'/template6'+'/Additional-Information'+'/Additional-Information-info').once('value')
 .then((snapshot) => {
    const AdditionalInformationinfo = snapshot.val();
...
{ const database = firebase.database();
 ...
 var Certificationinfo=document.getElementById("Certificationinfo");
 var CertificationDate=document.getElementById("CertificationDate");
 database.ref('users/'+user.uid+'/template6'+'/Certification').child('CertificationDate').set(CertificationDate.value);
 database.ref('users/'+user.uid+'/template6'+'/Certification').child('Certification-info').set(Certificationinfo.value);
 database.ref('users/' + user.uid +'/template6'+'/Certification').once('value')
 .then((snapshot) => {
    const Certificationinfos = snapshot.child('Certification-info').val();
...
function Interestsinfo(){
  ...
  var Interests2=document.getElementById("Interests2");
  var Interests3=document.getElementById("Interests3");
  database.ref('users/'+user.uid+'/template6'+'/Interest').child('Interests1-info').set(Interests1.value);
  database.ref('users/'+user.uid+'/template6'+'/Interest').child('Interests2-info').set(Interests2.value);
  database.ref('users/'+user.uid+'/template6'+'/Interest').child('Interests3-info').set(Interests3.value);
  database.ref('users/' + user.uid +'/template6'+'/Interest').once('value')
.then((snapshot) => {
   const Interests1info = snapshot.child('Interests1-info').val();
   const Interests2info = snapshot.child('Interests2-info').val();
...
function personalsectioninfo()
{
  ...
  var personalsectionT=document.getElementById("personal-section-T");
  var useraddedsectiontextarea=document.getElementById("user-added-section-textarea");
  database.ref('users/'+user.uid+'/template6'+'/personal-section'+'/personal-section-info').set(useraddedsectiontextarea.value);
...
function softwareinfo()
{
  ...
  var Softwareinput3=document.getElementById("Softwareinput3");
  var Softwareinput4=document.getElementById("Softwareinput4");
  database.ref('users/'+user.uid+'/template6'+'/Software').child('Softwareinput1-info').set(Softwareinput1.value);
  database.ref('users/'+user.uid+'/template6'+'/Software').child('Softwareinput2-info').set(Softwareinput2.value);
  database.ref('users/'+user.uid+'/template6'+'/Software').child('Softwareinput3-info').set(Softwareinput3.value);
  database.ref('users/'+user.uid+'/template6'+'/Software').child('Softwareinput4-info').set(Softwareinput4.value);
  database.ref('users/' + user.uid +'/template6'+'/Software').once('value')
  .then((snapshot) => {
     const Interests1info = snapshot.child('Softwareinput1-info').val();
     const Interests2info = snapshot.child('Softwareinput2-info').val();
...
{const database = firebase.database();
  ...
  database.ref('users/'+user.uid+'/template6'+'/Language').child('Language1-info').set(Language1.value);
  database.ref('users/'+user.uid+'/template6'+'/Language').child('Language2-info').set(Language2.value);
  database.ref('users/'+user.uid+'/template6'+'/Language').child('Language3-info').set(Language3.value);
  database.ref('users/'+user.uid+'/template6'+'/Language').child('Language4-info').set(Language4.value);
...
function skillinfo()
{
  ...
  database.ref('users/'+user.uid+'/template6'+'/skill').child('Skill-input1').set(Skillinput1.value);
  database.ref('users/'+user.uid+'/template6'+'/skill').child('Skill-input2').set(Skillinput2.value);
  database.ref('users/'+user.uid+'/template6'+'/skill').child('Skill-input3').set(Skillinput3.value);
  database.ref('users/'+user.uid+'/template6'+'/skill').child('Skill-input4').set(Skillinput4.value);
...
function Accomplishmentinfo()
{
  ...
  var user = firebase.auth().currentUser;
  var Accomplishmentstextarea=document.getElementById("Accomplishments-textarea");
  database.ref('users/'+user.uid+'/template6'+'/Accompliments').child('Accomplishments-info').set(Accomplishmentstextarea.value);
...
let WorkExtextarea="";
  ...
  let WorkExdateT=document.getElementById("Work-Ex-date")
  database.ref('users/'+user.uid+'/template6'+'/Work-Experience2').child('Job-Title').set(Jobtitleinputw2)
  database.ref('users/'+user.uid+'/template6'+'/Work-Experience2').child('Employer-Position').set(Employerinput)
  database.ref('users/'+user.uid+'/template6'+'/Work-Experience2').child('City-Work').set(CityinputWorkexperience)
  database.ref('users/'+user.uid+'/template6'+'/Work-Experience2').child('Country').set(CountryinputWorkexperience)
  database.ref('users/'+user.uid+'/template6'+'/Work-Experience2').child('Start-Date').set(StartDateWorkExinput)
  database.ref('users/'+user.uid+'/template6'+'/Work-Experience2').child('End-Date').set(EndDateWorkExinput)

  database.ref('users/'+user.uid+'/template6'+'/Work-Experience2').child('Work-Experience-Info').set(WorkExtextarea)
}
...
document.getElementById("work-ex-id-3T").style.display=
  ...
  let WorkExdateT=document.getElementById("Work-Ex-date")
  database.ref('users/'+user.uid+'/template6'+'/Work-Experience3').child('Job-Title').set(Jobtitleinputw2)
  database.ref('users/'+user.uid+'/template6'+'/Work-Experience3').child('Employer-Position').set(Employerinput)
  database.ref('users/'+user.uid+'/template6'+'/Work-Experience3').child('City-Work').set(CityinputWorkexperience)
  database.ref('users/'+user.uid+'/template6'+'/Work-Experience3').child('Country').set(CountryinputWorkexperience)
  database.ref('users/'+user.uid+'/template6'+'/Work-Experience3').child('Start-Date').set(StartDateWorkExinput)
  database.ref('users/'+user.uid+'/template6'+'/Work-Experience3').child('End-Date').set(EndDateWorkExinput)

  database.ref('users/'+user.uid+'/template6'+'/Work-Experience3').child('Work-Experience-Info').set(WorkExtextarea)
}
...
let Educationtextarea="";
  ...
  database.ref('users/'+user.uid+'/template6'+'/Education2').child('School-Name').set(SchoolNameinput)
  database.ref('users/'+user.uid+'/template6'+'/Education2').child('School-Location').set(SchoolLocationinput)
  database.ref('users/'+user.uid+'/template6'+'/Education2').child('Degree').set(Degreeinput)
  database.ref('users/'+user.uid+'/template6'+'/Education2').child('Field-of-Study').set(FieldofStudy)
  database.ref('users/'+user.uid+'/template6'+'/Education2').child('Graduation-Start-Date').set(GraduationStartDate)
  database.ref('users/'+user.uid+'/template6'+'/Education2').child('Graduation-End-Date').set(GraduationEndDate)

  database.ref('users/'+user.uid+'/template6'+'/Education2').child('Education-Info').set(Educationtextarea)
...
let Educationtextarea="";
  ...
  database.ref('users/'+user.uid+'/template6'+'/Education3').child('School-Name').set(SchoolNameinput)
  database.ref('users/'+user.uid+'/template6'+'/Education3').child('School-Location').set(SchoolLocationinput)
  database.ref('users/'+user.uid+'/template6'+'/Education3').child('Degree').set(Degreeinput)
  database.ref('users/'+user.uid+'/template6'+'/Education3').child('Field-of-Study').set(FieldofStudy)
  database.ref('users/'+user.uid+'/template6'+'/Education3').child('Graduation-Start-Date').set(GraduationStartDate)
  database.ref('users/'+user.uid+'/template6'+'/Education3').child('Graduation-End-Date').set(GraduationEndDate)

  database.ref('users/'+user.uid+'/template6'+'/Education3').child('Education-Info').set(Educationtextarea)
